...
public class TimeMachinePlayer : MonoBehaviour
{
    ...
    [FormerlySerializedAs("playableDirector")] public PlayableDirector timeMachinePlayableDirector;
    #endif
    void Start()
    {
    ...
    public void CreateTimelineAsset()
    {
        if (timeMachinePlayableDirector == null)
        {
            ...
            if (timeMachinePlayableDirector == null) timeMachinePlayableDirector = gameObject.AddComponent<PlayableDirector>();
        }
